# show menu or enter canonical entry
...
- Capsule [f28a642e29385086] Task focus: show menu or enter canonical entry
  Owner: state_store
  Why now: Matched state_store memory for requirement_doc.
  Expansion Ref: E:\GzrjxyGzrjxyGzrjxyGzrjxy\Project documents for all departments\AInything\OPPO便签导出系统\outputs\runtime\vibe-sessions\20260614T125316Z-831011be\memory-activation\skeleton-local-digest.json#f28a642e29385086
  Summary: Task focus: show menu or enter canonical entry
  Summary: Git branch: 
