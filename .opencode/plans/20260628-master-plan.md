...
| 批次 | Plan 列表 | 数量 | 触发条件 |
|------|----------|------|---------|
| **批0** | A1∥A2∥A3∥A4∥A5∥A6∥A7∥A8∥A9∥A10 | 10 | ✅ 已完成 |
| **批1** | B1∥B2∥B5 ∥ C13∥C14∥C15∥C16∥C27∥C28 ∥ C18∥C19∥C20∥C21∥C22 ∥ C24∥C9∥C11 ∥ C29∥C30∥C31∥C32∥C33∥C34∥C35 | 23 | ✅ 已完成 |
| **批2** | B3, B4, B6, B7, B8, C17, C10, C12, C23 | 9 | ✅ 已完成 |
| **批3** | C25, C26 | 2 | ✅ 已完成 |
